...
```
## Introduction
성균관대학교 소프트웨어학과 4학년 정윤석입니다. 평소 네트워크 보안 쪽에 관심이 있어 해당 분야로 진출하기 위해 부단히 노력 중입니다. <br>
```

```###Skills
1. Python
세부 기술 : Pytorch, Tensorflow, Pandas, yfinance
- Python 언어의 문법에 대해 숙지하고 Python으로 골드 수준의 PS 문제를 푸는 정
도입니다.
...
###Education
1. 성균관대학교
기간 | 2021/2~2023/6(편입)(현재 4학년 2학기)
전공 | 소프트웨어학과
학점/만점 | 3.92/4.5

2. 네이버 AI Tech 부스트캠프 5기
기간 : 2023/3 ~ 2023/08
```
